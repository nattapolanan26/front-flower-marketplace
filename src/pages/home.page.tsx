...
import { Col, Row, Card, Typography, Image, Space, Empty } from "antd";
import CarouselSlide from "@/views/home/Slide";
import {
  DownloadOutlined,
  RotateLeftOutlined,
  RotateRightOutlined,
    ...
    products.length > 0 ? (
      products.map((row) => (
        ...
        >
          ...
          >
            <Typography.Title level={5}>{row.product_name}</Typography.Title>
      ...
      <div style={{ textAlign: "center", width: "100%" }}>
        <Empty
          ...
          description="ไม่พบข้อมูลสินค้าบน Marketplace"
        />
      </div>
    )
  ) : null;
